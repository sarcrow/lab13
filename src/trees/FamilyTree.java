...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("there's no parent!"); // throw a TreeException with a useful message
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException("there's still no parent!");
			}
		}
		...
		for (String child : childrenArray) {
			TreeNode bruh = new TreeNode(child);
			parentNode.addChild(bruh);
		}
	}
